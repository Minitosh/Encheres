...
public class RetraitDAOJdbcImpl implements RetraitDAO {
	...
	private static final String SELECT_RETRAIT = "	SELECT r.no_article as noArticle," + "	r.rue,"
			+ "	r.code_postal as codePostal," + "	r.ville" + " FROM" + "	RETRAITS r" + " WHERE r.no_article = ?";
	...
	public Retrait select(int noArticle) throws BusinessException {
		...
		try (Connection cnx = ConnectionProvider.getConnection()) {
			...
			while (rs.next()) {
				if (rs.getInt("noArticle") != retrait.getNoArticle()) {
