...
public class RetraitManager {
	...
	public Retrait ajouterRetrait(int noArticle, String rue, String codePostal, String ville)
			throws BusinessException, AddRetraitException {
		...
		if (!businessException.hasErreurs()) {
			...
			throw new AddRetraitException(
					"erreur lors de l'ajout de l'adresse de retrait, les données ne sont pas valide");
		}
