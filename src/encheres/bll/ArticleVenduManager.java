...
public class ArticleVenduManager {
	...
	public ArticleVendu ajouterArticleVendu(String nomArticle, String description, Date dateDebutEncheres,
			Date dateFinEncheres, int miseAPrix, int prixVente, int noUtilisateur, int noCategorie)
			throws AddArticleVenduException, BusinessException {
		...
		if (!businessException.hasErreurs()) {
			...
			throw new AddArticleVenduException("erreur lors de l'ajout de l'article, les données ne sont pas valide");
		}
	...
	public List<ArticleVendu> selectionnerTousLesArticleVenduParNoUtilisateur(int noUtilisateur)
